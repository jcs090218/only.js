...
only.Config.FPS = 30;
only.Config.TITLE = "Rotation Example";
...
function update () {
  disObj.rotateX += 100 * only.Time.FIXED_TIME;
  disObj.rotateY += 100 * only.Time.FIXED_TIME;
  disObj.rotateZ += 20 * only.Time.FIXED_TIME;
}
